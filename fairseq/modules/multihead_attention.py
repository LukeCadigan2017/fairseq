...
from torch.nn.functional import _check_key_padding_mask, linear, _mha_shape_check, _canonical_mask, _in_projection_packed, _in_projection, pad, scaled_dot_product_attention, softmax, dropout, _none_or_dtype
